...
export const searchIndex: SearchResult[] = [
  ...
  },
  {
    id: 'sidebar',
    title: 'Sidebar',
    description: 'A composable sidebar with header, content, and footer slots',
    type: 'component',
    category: 'Layout',
    path: '/docs/layout/sidebar',
    keywords: ['sidebar', 'navigation', 'nav', 'panel', 'layout'],
  },
  {
    id: 'app-sidebar',
    title: 'App Sidebar',
    description: 'Collapsible ChatGPT-style sidebar that animates between full width and icon rail',
    type: 'component',
    category: 'Layout',
    path: '/docs/layout/app-sidebar',
    keywords: ['sidebar', 'collapsible', 'navigation', 'rail', 'layout', 'app'],
  },
  {
    id: 'drawer',
    title: 'Drawer',
